...
import { initAnimePlaylist } from "./anime-playlists/anime-playlist.js";
...
function navigateAnimeMenu() {
      ...
      spa_navigation.navigateAnchorLink('anime-playlists', 'anime-section', api_configs.endpoints.adminAnimePlaylistPage, initAnimePlaylist ); 
}